...
public class UpdateItemActivity extends Activity implements OnFocusChangeListener
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	 {
			...
			Intent in=getIntent();
			final Item e=(Item)in.getSerializableExtra("Item");
			t1.setText(e.getId()+"");
			...
			button1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v)
				{
					...
					int id=e.getId();
					Item enew=new Item(name, amount, date,id);
